...
/* 요금 계산 함수: 
-0은 falsy라 if(age)에서 검사하면 값이 없음으로 이해함.
-상단에 null/undefined부터 먼저 판별해 0살도 switch문에서 정상 출력되도록 함. 
*/
...
function testAge(age,bage) {
    ...
    document.getElementById('result').innerHTML =
        `<h3> ${displayAge} ${displayBage} 결과:</h3><p>${result}</p>`;
}
